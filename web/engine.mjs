...
const _M0MPB4Iter4nextN6constrS9855GUsRPB5ArrayGsEEE = 0;
const _M0MPB4Iter4nextN6constrS9856GUsRPB5ArrayGsEEE = 0;
...
function _M0MPB4Iter4nextGUsRPB5ArrayGsEEE(self) {
  const _func = self.f;
  const result = _func();
  const _bind = self.size_hint;
  if (result === undefined) {
    self.size_hint = _M0MPB4Iter4nextN6constrS9856GUsRPB5ArrayGsEEE;
  } else {
    if (_bind === undefined) {
    } else {
      const _Some = _bind;
      const _n = _Some;
      self.size_hint = _n > 0 ? _n - 1 | 0 : _M0MPB4Iter4nextN6constrS9855GUsRPB5ArrayGsEEE;
    }
  }
  return result;
}
...
function _M0MPB4Iter3mapGssE(self, f) {
  return new _M0TPB4IterGsE(() => {
    const _bind = _M0MPB4Iter4nextGUsRPB5ArrayGsEEE(self);
    if (_bind === undefined) {
      return undefined;
    } else {
      const _Some = _bind;
...
function _M0MPC16option6Option6unwrapGRPB5EntryGsRPB5ArrayGsEEE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPB5Iter24nextGsRPB5ArrayGsEE(self) {
  return _M0MPB4Iter4nextGUsRPB5ArrayGsEEE(self);
}
...
function _M0MPC15array5Array3popGsE(self) {
  if (_M0MPC15array5Array9is__emptyGRPC15debug7ContentE(self)) {
    return undefined;
  } else {
...
function _M0MPC15array5Array10push__iterGsE(self, iter) {
  ...
  while (true) {
    const _bind$2 = _M0MPB4Iter4nextGUsRPB5ArrayGsEEE(iter);
...
function _M0FP211localreview5forth14bracket__chunk(body, start) {
  ...
  while (true) {
    if (pc.val < body.length) {
      ...
      _M0MPC15array5Array4pushGsE(chunk, word);
      continue;
    } else {
      break;
    }
  ...
  while (true) {
    if (pc.val < body.length) {
      ...
      if (word === "[") {
        let next;
        _L: {
          const _bind = _M0FP211localreview5forth14bracket__chunk(body, pc.val);
          let _bind$2;
          if (_bind.$tag === 1) {
            const _ok = _bind;
            _bind$2 = _ok._0;
      ...
      _L: {
              ...
              _L$5: {
                _L$6: {
                  switch (word) {
                    ...
                    case "else": {
                      if (_M0IP016_24default__implPB2Eq10not__equalGOsE(_M0MPC15array5Array3popGsE(scopes), "if")) {
                      ...
                      _M0MPC15array5Array4pushGsE(scopes, "else");
                      break;
                    }
                    case "then": {
                      const open = _M0MPC15array5Array3popGsE(scopes);
                    ...
                    case "while": {
                      if (_M0IP016_24default__implPB2Eq10not__equalGOsE(_M0MPC15array5Array3popGsE(scopes), "begin")) {
                      ...
                      _M0MPC15array5Array4pushGsE(scopes, "while");
                      break;
                    }
                    case "repeat": {
                      if (_M0IP016_24default__implPB2Eq10not__equalGOsE(_M0MPC15array5Array3popGsE(scopes), "while")) {
                    ...
                    case "does>": {
                      if (!_M0MPC15array5Array9is__emptyGRPC15debug7ContentE(scopes)) {
                ...
                _M0MPC15array5Array4pushGsE(scopes, word === "?do" ? "do" : word);
              }
              break _L$3;
            }
            if (_M0IP016_24default__implPB2Eq10not__equalGOsE(_M0MPC15array5Array3popGsE(scopes), "begin")) {
        ...
        if (_M0IP016_24default__implPB2Eq10not__equalGOsE(_M0MPC15array5Array3popGsE(scopes), "do")) {
  ...
  while (true) {
    if (pc.val < code.length) {
      ...
      if (word === "while" && nesting.val === 1) {
        ...
        if (after_while.val) {
          _M0MPC15array5Array4pushGsE(tail, word);
        } else {
          _M0MPC15array5Array4pushGsE(body, word);
        }
      }
      continue;
    } else {
...
function _M0MP211localreview5forth7Machine12attach__does(self, tail) {
  ...
  let created;
  const _bind = self.latest_created;
  if (_bind.$tag === 1) {
    const _Some = _bind;
  ...
  while (true) {
    if (created.length > 2) {
      _M0MPC15array5Array3popGsE(created);
      continue;
    } else {
      break;
    }
  }
  const _bind$2 = tail.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$2) {
      const token = tail[_];
      _M0MPC15array5Array4pushGsE(created, token);
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP211localreview5forth7Machine13body__address(self, xt) {
  ...
  if (body.length >= 2) {
    ...
    _L: {
      _L$2: {
        const _bind = _M0MPB3Map3getGsiE(self.data_addresses, _M0MPC15array5Array2atGsE(body, 1));
        if (_bind === undefined) {
        } else {
          const _Some = _bind;
...
function _M0MP211localreview5forth7Machine11capture__xt(self, name) {
  let body;
  const _bind = _M0MPB3Map3getGsRPB5ArrayGsEE(self.words, name);
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _body = _Some._0;
    body = _body;
  ...
  const _bind$2 = 0;
  const _bind$3 = self.execution_tokens.length;
  let _tmp = _bind$2;
  while (true) {
    const i = _tmp;
    if (i < _bind$3) {
...
function _M0MP211localreview5forth7Machine3pop(self) {
  let v;
  _L: {
    const _bind = _M0MPC15array5Array3popGiE(self.stack);
    if (_bind === undefined) {
...
function _M0MP211localreview5forth7Machine14postpone__into(self, name, output) {
  const _bind = _M0MPB3Map3getGsRPB5ArrayGsEE(self.words, name);
  if (_bind.$tag === 1) {
    const _bind$2 = _M0MP211localreview5forth7Machine11capture__xt(self, name);
    let xt;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      xt = _ok._0;
...
function _M0MP211localreview5forth7Machine15emit__postponed(self, name) {
  let output;
  const _bind = self.compile_output;
  if (_bind.$tag === 1) {
    const _Some = _bind;
...
function _M0MP211localreview5forth7Machine12return__word(self, word) {
  let count;
  const _bind = "2";
  if (_M0MPC16string6String11has__prefix(word, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    count = 2;
  } else {
    count = 1;
  }
...
function _M0MP211localreview5forth7Machine13runtime__name(self, code, pc, depth) {
  let _tmp;
  if (depth === 0) {
    if (pc >= code.length) {
      return new _M0DTPC16result6ResultGUsiERP211localreview5forth10ForthErrorE3Err(new _M0DTPC15error5Error42localreview_2fforth_2eForthError_2eInvalid("missing input name"));
    }
    self.input_pc = pc + 1 | 0;
    _tmp = { _0: _M0MPC15array5Array2atGsE(code, pc), _1: pc + 1 | 0 };
  } else {
    if (self.input_pc >= self.input.length) {
      return new _M0DTPC16result6ResultGUsiERP211localreview5forth10ForthErrorE3Err(new _M0DTPC15error5Error42localreview_2fforth_2eForthError_2eInvalid("missing input name"));
    }
    const name = _M0MPC15array5Array2atGsE(self.input, self.input_pc);
    self.input_pc = self.input_pc + 1 | 0;
    _tmp = { _0: name, _1: pc };
  }
  return new _M0DTPC16result6ResultGUsiERP211localreview5forth10ForthErrorE2Ok(_tmp);
}
...
function _M0MP211localreview5forth7Machine14execute__frame(self, code, depth, is_word) {
  ...
  let _err;
  _L: {
    const _bind = _M0MP211localreview5forth7Machine7execute(self, code, depth);
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _ok._0;
    } else {
...
function _M0MP211localreview5forth7Machine7execute(self, code, depth) {
  ...
  while (true) {
    if (pc.val < code.length) {
      ...
      const raw = _M0MPC15array5Array2atGsE(code, pc.val);
      const _bind = "\u0001";
      const builtin = _M0MPC16string6String11has__prefix(raw, new _M0TPC16string10StringView(_bind, 0, _bind.length));
      const word = builtin ? _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(raw, 1, undefined)) : raw;
      pc.val = pc.val + 1 | 0;
      if (depth === 0) {
        self.input_pc = pc.val;
      }
      const _bind$2 = "\u0002";
      if (_M0MPC16string6String11has__prefix(raw, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
        const _bind$3 = _M0MP211localreview5forth7Machine15emit__postponed(self, _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(raw, 1, undefined)));
        if (_bind$3.$tag === 1) {
          const _ok = _bind$3;
          _ok._0;
        } else {
        ...
        if (word === "'") {
          ...
          let next;
          _L: {
            const _bind$3 = _M0MP211localreview5forth7Machine13runtime__name(self, code, pc.val, depth);
            let _bind$4;
            if (_bind$3.$tag === 1) {
              const _ok = _bind$3;
              _bind$4 = _ok._0;
          ...
          if (word === "variable" || (word === "constant" || word === "create")) {
            ...
            _L$2: {
              _L$3: {
                const _bind$3 = _M0FP211localreview5forth6number(name);
            ...
            if (word === "constant") {
              ...
              const _bind$3 = _M0MP211localreview5forth7Machine8allocate(self, (4 - (self.memory.length % 4 | 0) | 0) % 4 | 0);
              if (_bind$3.$tag === 1) {
                const _ok = _bind$3;
                _ok._0;
              } else {
              ...
              if (word === "variable") {
                const _bind$4 = _M0MP211localreview5forth7Machine8allocate(self, 4);
                if (_bind$4.$tag === 1) {
                  const _ok = _bind$4;
                  _ok._0;
                } else {
            ...
            if (word === "create") {
              ...
              _M0MPC15array5Array4pushGsE(data_body, identity);
            ...
            if (word === "does>") {
              const _bind$3 = _M0MP211localreview5forth7Machine12attach__does(self, _M0MPC15array9ArrayView9to__ownedGsE(_M0MPC15array5Array12view_2einnerGsE(code, pc.val, undefined)));
              if (_bind$3.$tag === 1) {
                const _ok = _bind$3;
                _ok._0;
              } else {
              ...
              if (word === ":" || word === ":noname") {
                ...
                if (anonymous) {
                  ...
                  const name$2 = _M0MPC15array5Array2atGsE(code, pc.val);
                  pc.val = pc.val + 1 | 0;
                  name = name$2;
                }
                _L: {
                ...
                while (true) {
                  if (pc.val < code.length && _M0IP016_24default__implPB2Eq10not__equalGsE(_M0MPC15array5Array2atGsE(code, pc.val), ";")) {
                    if (_M0MPC15array5Array2atGsE(code, pc.val) === ":" || _M0MPC15array5Array2atGsE(code, pc.val) === ":noname") {
                ...
                pc.val = pc.val + 1 | 0;
                const _bind$3 = _M0MP211localreview5forth7Machine13compile__word(self, name, body);
                if (_bind$3.$tag === 1) {
                  const _ok = _bind$3;
                  _ok._0;
                } else {
                ...
                if (word === "do" || word === "?do") {
                  ...
                  let next;
                  _L: {
                    const _bind$3 = _M0FP211localreview5forth13counted__body(code, pc.val);
                    let _bind$4;
                    if (_bind$3.$tag === 1) {
                      const _ok = _bind$3;
                      _bind$4 = _ok._0;
                    ...
                    const _body = _bind$4._0;
                    const _plus = _bind$4._1;
                    const _next = _bind$4._2;
                    plus = _plus;
                    body = _body;
                    next = _next;
                    break _L;
                  ...
                  if (word === "do" || start !== limit) {
                    const _bind$5 = _M0MP211localreview5forth7Machine13counted__loop(self, body, start, limit, plus, depth + 1 | 0);
                    if (_bind$5.$tag === 1) {
                      const _ok = _bind$5;
                      _ok._0;
                    } else {
                  ...
                  if (word === "begin") {
                    ...
                    let next;
                    _L: {
                      const _bind$3 = _M0FP211localreview5forth11begin__body(code, pc.val);
                      let _bind$4;
                      if (_bind$3.$tag === 1) {
                        const _ok = _bind$3;
                        _bind$4 = _ok._0;
                      ...
                      const _body = _bind$4._0;
                      const _tail = _bind$4._1;
                      const _ending = _bind$4._2;
                      const _next = _bind$4._3;
                      ending = _ending;
                      body = _body;
                      tail = _tail;
                      next = _next;
                    ...
                    while (true) {
                      ...
                      const _bind$3 = _M0MP211localreview5forth7Machine7execute(self, body, depth + 1 | 0);
                      if (_bind$3.$tag === 1) {
                        const _ok = _bind$3;
                        _ok._0;
                      } else {
                      ...
                      if (ending === "until") {
                        ...
                        if (ending === "repeat") {
                          ...
                          const _bind$5 = _M0MP211localreview5forth7Machine7execute(self, tail, depth + 1 | 0);
                          if (_bind$5.$tag === 1) {
                            const _ok = _bind$5;
                            _ok._0;
                          } else {
                    ...
                    if (word === "if") {
                      ...
                      const _bind$4 = _M0MP211localreview5forth7Machine7execute(self, condition !== 0 ? yes : no, depth + 1 | 0);
                      if (_bind$4.$tag === 1) {
                        const _ok = _bind$4;
                        _ok._0;
                      } else {
                        ...
                        _L: {
                          _L$2: {
                            if (!builtin) {
                              let body;
                              _L$3: {
                                const _bind$3 = _M0MPB3Map3getGsRPB5ArrayGsEE(self.words, word);
                                if (_bind$3.$tag === 1) {
                                  const _Some = _bind$3;
                                  const _body = _Some._0;
                                  body = _body;
                              ...
                              const _bind$3 = _M0MP211localreview5forth7Machine14execute__frame(self, body, depth + 1 | 0, true);
                              if (_bind$3.$tag === 1) {
                                const _ok = _bind$3;
                                _ok._0;
                              } else {
                          ...
                          _L$3: {
                            _L$4: {
                              const _bind$3 = _M0FP211localreview5forth6number(word);
                              if (_bind$3 === undefined) {
                                _L$5: {
                                  _L$6: {
                                    _L$7: {
      ...
      if (depth === 0) {
        pc.val = pc.val > self.input_pc ? pc.val : self.input_pc;
      }
...
function _M0MP211localreview5forth7Machine13compile__word(self, name, body) {
  const old_binding_id = self.binding_id;
  const old_tokens = self.execution_tokens.length;
  let _err;
  _L: {
    const _bind = [];
    const pending = _M0MPB3Map3MapGsRPB5ArrayGsEE(new _M0TPB9ArrayViewGUsRPB5ArrayGsEEE(_bind, 0, 0), undefined);
    const _bind$2 = _M0MP211localreview5forth7Machine12binding__key(self);
    let own;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      own = _ok._0;
    ...
    _L$2: {
      const _bind$3 = [];
      const captures = _M0MPB3Map3MapGssE(new _M0TPB9ArrayViewGUssEE(_bind$3, 0, 0), undefined);
      ...
      while (true) {
        if (pc.val < body.length) {
          ...
          if (word === "postpone") {
            if (pc.val >= body.length) {
              _err$2 = new _M0DTPC15error5Error42localreview_2fforth_2eForthError_2eInvalid("missing POSTPONE name");
              break _L$2;
            }
            const _bind$4 = _M0MP211localreview5forth7Machine14postpone__into(self, _M0MPC15array5Array2atGsE(body, pc.val), compiled);
            if (_bind$4.$tag === 1) {
              const _ok = _bind$4;
              _ok._0;
            } else {
            ...
            if (word === "[") {
              ...
              let next;
              _L$3: {
                const _bind$4 = _M0FP211localreview5forth14bracket__chunk(body, pc.val);
                let _bind$5;
                if (_bind$4.$tag === 1) {
                  const _ok = _bind$4;
                  _bind$5 = _ok._0;
              ...
              pc.val = next;
              const _bind$4 = _M0MP211localreview5forth7Machine25interpret__compile__chunk(self, chunk);
              if (_bind$4.$tag === 1) {
                const _ok = _bind$4;
                _ok._0;
              } else {
              ...
              if (word === "literal") {
                ...
                if (word === "does>") {
                  ...
                  if (word === "[']") {
                    ...
                    const _bind$4 = _M0MP211localreview5forth7Machine11capture__xt(self, _M0MPC15array5Array2atGsE(body, pc.val));
                    let _tmp;
                    if (_bind$4.$tag === 1) {
                      const _ok = _bind$4;
                      _tmp = _ok._0;
                        ...
                        _L$4: {
                          if (_M0MPC15array5Array8containsGsE(controls, word)) {
                            ...
                            if (_bind$4 === undefined) {
                              ...
                              _L$5: {
                                _L$6: {
                                  const _bind$5 = _M0MPB3Map3getGsRPB5ArrayGsEE(self.words, word);
                                  if (_bind$5.$tag === 1) {
                                    const _Some = _bind$5;
                                ...
                                if (_M0IPC16option6OptionPB2Eq5equalGbE(_M0MPB3Map3getGsbE(self.immediate_words, word), true)) {
                                  const _bind$5 = _M0MP211localreview5forth7Machine14run__immediate(self, target, body, pc.val);
                                  let _tmp;
                                  if (_bind$5.$tag === 1) {
                                    const _ok = _bind$5;
                                    _tmp = _ok._0;
                                ...
                                let key;
                                const _bind$5 = _M0MPB3Map3getGssE(captures, word);
                                if (_bind$5 === undefined) {
                                  const _bind$6 = _M0MP211localreview5forth7Machine12binding__key(self);
                                  let key$2;
                                  if (_bind$6.$tag === 1) {
                                    const _ok = _bind$6;
                                    key$2 = _ok._0;
      ...
      const _bind$4 = _M0FP211localreview5forth19validate__structure(_M0MPC15array5Array3mapGssE(compiled, (word) => word === "\u0001does>" ? "does>" : word));
      if (_bind$4.$tag === 1) {
        const _ok = _bind$4;
        _ok._0;
      } else {
  ...
  while (true) {
    if (self.execution_tokens.length > old_tokens) {
...
function _M0MP211localreview5forth7Machine25interpret__compile__chunk(self, chunk) {
  ...
  let _err;
  _L: {
    const _bind = _M0MP211localreview5forth7Machine14execute__frame(self, chunk, 0, false);
    let _defer_result;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _ok._0;
...
function _M0MP211localreview5forth7Machine13counted__loop(self, body, start, limit, plus, depth) {
  ...
  _L: {
    while (true) {
      ...
      const _bind = _M0MP211localreview5forth7Machine7execute(self, body, depth);
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _ok._0;
      } else {
...
function _M0FP211localreview5forth6tokens(source) {
  const out = [];
  const word = new _M0TPB8MutLocalGsE("");
  const comment = new _M0TPB8MutLocalGbE(false);
  const line_comment = new _M0TPB8MutLocalGbE(false);
  ...
  while (true) {
    ...
    if (c === 0 || (c === 1 || c === 2)) {
      return new _M0DTPC16result6ResultGRPB5ArrayGsERP211localreview5forth10ForthErrorE3Err(new _M0DTPC15error5Error42localreview_2fforth_2eForthError_2eInvalid("reserved source character"));
    }
    if (line_comment.val) {
      if (c === 10) {
        line_comment.val = false;
      }
      continue;
    }
    if (comment.val) {
    ...
    if (c === 40 || (c === 92 || (c === 32 || (c === 10 || (c === 13 || c === 9))))) {
      if (_M0IP016_24default__implPB2Eq10not__equalGsE(word.val, "")) {
        _M0MPC15array5Array4pushGsE(out, _M0MPC16string6String9to__lower(word.val));
        word.val = "";
      }
      if (c === 40) {
        comment.val = true;
  ...
  if (comment.val) {
    return new _M0DTPC16result6ResultGRPB5ArrayGsERP211localreview5forth10ForthErrorE3Err(new _M0DTPC15error5Error42localreview_2fforth_2eForthError_2eInvalid("unterminated comment"));
  }
  if (_M0IP016_24default__implPB2Eq10not__equalGsE(word.val, "")) {
    _M0MPC15array5Array4pushGsE(out, _M0MPC16string6String9to__lower(word.val));
  }
  return new _M0DTPC16result6ResultGRPB5ArrayGsERP211localreview5forth10ForthErrorE2Ok(out);
}
function _M0MP211localreview5forth7Machine12eval_2einner(self, source, budget) {
  if (budget < 1 || source.length > 1000000) {
    return new _M0DTPC16result6ResultGuRP211localreview5forth10ForthErrorE3Err(new _M0DTPC15error5Error42localreview_2fforth_2eForthError_2eInvalid("invalid input limit"));
  }
  self.fuel = budget;
  const _bind = _M0FP211localreview5forth6tokens(source);
  let input;
  if (_bind.$tag === 1) {
    const _ok = _bind;
    input = _ok._0;
  ...
  let _err;
  _L: {
    const _bind$2 = _M0MP211localreview5forth7Machine14execute__frame(self, input, 0, false);
    let _defer_result;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      _ok._0;
...
function _M0FP411localreview5forth3cmd3web3run(input) {
  ...
  _L: {
    ...
    const _bind = _M0MP211localreview5forth7Machine12eval_2einner(m, input, 20000);
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _ok._0;
    } else {
...
export { _M0FP411localreview5forth3cmd3web3run as run }
